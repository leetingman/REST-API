...
import me.liting.restapiwithspring.accounts.AccountAdpter;
import me.liting.restapiwithspring.accounts.CurrentUser;
...
//        User principal = (User)authentication.getPrincipal();//return AccountService of user //if hav current then user->account
